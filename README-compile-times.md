...
- **Commit:** [661643e](https://github.com/ggml-org/llama.cpp/commit/661643e) (sycl : fix oneDNN scratchpad breaking the pool free order (#28704))
...
| Time | File |
|------|------|
| 2.7s | [ggml/src/ggml-cpu/ops.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/ggml-cpu/ops.cpp) |
| 1.4s | [ggml/src/ggml-quants.c](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/ggml-quants.c) |
| 1.3s | [ggml/src/ggml-cpu/repack.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/ggml-cpu/repack.cpp) |
| 0.9s | [ggml/src/ggml-cpu/binary-ops.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/ggml-cpu/binary-ops.cpp) |
| 0.9s | [ggml/src/ggml-cpu/unary-ops.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/ggml-cpu/unary-ops.cpp) |
| 0.8s | [ggml/src/ggml-backend-meta.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/ggml-backend-meta.cpp) |
| 0.8s | [ggml/src/gguf.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/gguf.cpp) |
| 0.6s | [ggml/src/ggml-cpu/llamafile/sgemm.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/ggml-cpu/llamafile/sgemm.cpp) |
| 0.5s | [ggml/src/ggml-blas/ggml-blas.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/ggml-blas/ggml-blas.cpp) |
| 0.5s | [ggml/src/ggml-cpu/vec.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/ggml/src/ggml-cpu/vec.cpp) |
...
| Time | File |
|------|------|
| 1.8s | [src/llama-model.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/src/llama-model.cpp) |
| 1.6s | [src/llama-kv-cache.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/src/llama-kv-cache.cpp) |
| 1.5s | [src/unicode.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/src/unicode.cpp) |
| 1.3s | [src/llama-vocab.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/src/llama-vocab.cpp) |
| 1.2s | [src/llama-sampler.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/src/llama-sampler.cpp) |
| 1.2s | [src/llama-model-loader.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/src/llama-model-loader.cpp) |
| 1.1s | [src/llama-quant.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/src/llama-quant.cpp) |
| 1.1s | [src/llama-grammar.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/src/llama-grammar.cpp) |
...
| Time | File |
|------|------|
| 3.1s | [common/arg.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/arg.cpp) |
| 2.1s | [common/jinja/value.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/jinja/value.cpp) |
| 2.1s | [common/peg-parser.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/peg-parser.cpp) |
| 1.9s | [common/chat-diff-analyzer.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/chat-diff-analyzer.cpp) |
| 1.5s | [common/download.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/download.cpp) |
| 1.4s | [common/chat.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/chat.cpp) |
| 1.4s | [common/preset.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/preset.cpp) |
| 1.3s | [common/json-schema-to-grammar.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/json-schema-to-grammar.cpp) |
| 1.3s | [common/json.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/json.cpp) |
| 1.2s | [common/speculative.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/speculative.cpp) |
| 1.2s | [common/chat-peg-parser.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/chat-peg-parser.cpp) |
| 1.1s | [common/common.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/common.cpp) |
| 1.0s | [common/jinja/runtime.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/jinja/runtime.cpp) |
| 0.9s | [common/jinja/caps.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/jinja/caps.cpp) |
| 0.9s | [common/parsers/deepseek.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/deepseek.cpp) |
| 0.8s | [common/parsers/minimax-m3.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/minimax-m3.cpp) |
| 0.8s | [common/chat-auto-parser-generator.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/chat-auto-parser-generator.cpp) |
| 0.8s | [common/parsers/gemma4.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/gemma4.cpp) |
| 0.8s | [common/hf-cache.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/hf-cache.cpp) |
| 0.8s | [common/parsers/qwen3-coder.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/qwen3-coder.cpp) |
| 0.7s | [common/parsers/muse-glimmer.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/muse-glimmer.cpp) |
| 0.7s | [common/parsers/kimi-k3.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/kimi-k3.cpp) |
| 0.7s | [common/parsers/minicpm5.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/minicpm5.cpp) |
| 0.7s | [common/parsers/gpt-oss.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/gpt-oss.cpp) |
| 0.7s | [common/parsers/cohere2moe.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/cohere2moe.cpp) |
| 0.7s | [common/parsers/kimi-k2.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/common/parsers/kimi-k2.cpp) |
...
| 1.9s | [tools/mtmd/clip.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/mtmd/clip.cpp) |
...
| 0.9s | [tools/mtmd/mtmd.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/mtmd/mtmd.cpp) |
| 0.9s | [tools/server/server-mcp.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/server/server-mcp.cpp) |
| 0.9s | [tools/server/server-stream.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/server/server-stream.cpp) |
| 0.8s | [tools/server/server-chat.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/server/server-chat.cpp) |
| 0.8s | [tools/completion/completion.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/completion/completion.cpp) |
| 0.7s | [tools/mtmd/mtmd-image.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/mtmd/mtmd-image.cpp) |
| 0.7s | [tools/mtmd/mtmd-cli.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/mtmd/mtmd-cli.cpp) |
| 0.7s | [tools/mtmd/mtmd-audio.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/mtmd/mtmd-audio.cpp) |
| 0.6s | [tools/cli/cli.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/cli/cli.cpp) |
| 0.6s | [tools/mtmd/mtmd-helper-gen.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/mtmd/mtmd-helper-gen.cpp) |
| 0.6s | [tools/cli/cli-client.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/cli/cli-client.cpp) |
| 0.6s | [tools/cvector-generator/cvector-generator.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/cvector-generator/cvector-generator.cpp) |
| 0.5s | [tools/quantize/quantize.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/quantize/quantize.cpp) |
| 0.5s | [tools/export-lora/export-lora.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/export-lora/export-lora.cpp) |
| 0.5s | [tools/server/server-http.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/server/server-http.cpp) |
| 0.4s | [tools/mtmd/models/qwen3tts-gen.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/mtmd/models/qwen3tts-gen.cpp) |
| 0.4s | [tools/mtmd/debug/mtmd-debug.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/mtmd/debug/mtmd-debug.cpp) |
| 0.4s | [tools/mtmd/models/pockettts-gen.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tools/mtmd/models/pockettts-gen.cpp) |
...
| 1.3s | [tests/test-batch-alloc.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/test-batch-alloc.cpp) |
| 1.3s | [tests/gguf-model-data.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/gguf-model-data.cpp) |
| 1.0s | [tests/peg-parser/test-json-parser.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/peg-parser/test-json-parser.cpp) |
| 1.0s | [tests/test-model-resolution.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/test-model-resolution.cpp) |
| 0.9s | [tests/test-chat-template.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/test-chat-template.cpp) |
| 0.9s | [tests/test-backend-sampler.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/test-backend-sampler.cpp) |
...
| 0.4s | [tests/test-tokenizer-0.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/test-tokenizer-0.cpp) |
| 0.4s | [tests/test-reasoning-budget.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/test-reasoning-budget.cpp) |
| 0.3s | [tests/test-state-restore-fragmented.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/test-state-restore-fragmented.cpp) |
| 0.3s | [tests/test-alloc.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/test-alloc.cpp) |
...
| 0.2s | [tests/test-log.cpp](https://github.com/ggml-org/llama.cpp/blob/661643e/tests/test-log.cpp) |
